...
class App extends React.Component<OptionsEditorProps, OptionsEditorState> {
  ...
  setStatePromise(
    reducer:
      | ((state: Readonly<OptionsEditorState>) => Partial<OptionsEditorState>)
  ...
  async componentDidUpdate(prevProps, prevState) {
    if (prevState.options != null && prevState.options !== this.state.options) {
      ...
      <Container>
        ...
        {error == null ? (
          <>
            <h2>Rules:</h2>
            <p>
              Enter your rules below. Changes will automatically be synced
              across devices.
            </p>
            <p />
            <RulesList>
              {options.rules.map((rule, i) => (
                <RuleRow key={i}>
                  <select
                    value={rule.type}
                    onChange={e => this.setRuleType(i, +e.currentTarget.value)}
                  >
                    <option value={PinType.UrlExact}>URL is exactly:</option>
                    <option value={PinType.UrlMatch}>URL matches:</option>
                  ...
                  <ValueInput
                    ...
                    onChange={e => this.setRuleValue(i, e.currentTarget.value)}
                    placeholder={
          ...
          <ErrorInfo>
            ...
            <ul>
              ...
              <li>
                ...
                <HelpPre>
                  {JSON.stringify(this.state.options.rules, undefined, 2)}
                </HelpPre>
              </li>
            </ul>
          </ErrorInfo>
        ...
        <ExtensionInfo>
          ...
          <SyncWrap>
            <SyncMessage className={syncState}>Settings synced</SyncMessage>
          </SyncWrap>
        </ExtensionInfo>
      </Container>
    );
